    ...
    class iOSHardware
    {
        ...
        public string GetModel(string hardware)
        {
            ...
            if (hardware.StartsWith("iPhone"))
            {
                ...
                else if (hardware == "iPhone3,1" || hardware == "iPhone3,2")
                {
                    return "iPhone 4 GSM";
                }

                // Model(s): A1349
                else if (hardware == "iPhone3,3")
                {
                ...
                else if (hardware == "iPhone5,1")
                {
                    return "iPhone 5 GSM";
                }

                // Model(s): A1429 & A1442
                else if (hardware == "iPhone5,2")
                {
                ...
                else if (hardware == "iPhone5,3")
                {
                    return "iPhone 5C GSM";
                }

                // Model(s): A1507, A1516, A1526 & A1529
                else if (hardware == "iPhone5,4")
                {
                ...
                else if (hardware == "iPhone6,1")
                {
                    return "iPhone 5S GSM";
                }

                // Model(s): A1457, A1518, A1528 & A1530    
                else if (hardware == "iPhone6,2")
                {
                ...
                else if (hardware == "iPhone9,1" || hardware == "iPhone9,3")
                {
                    return "iPhone 7";
                }
                ...
                else if (hardware == "iPhone9,2" || hardware == "iPhone9,4")
                {
                ...
                else if (hardware == "iPhone10,1" || hardware == "iPhone10,4")
                {
                    return "iPhone 8";
                }
                ...
                else if (hardware == "iPhone10,2" || hardware == "iPhone10,5")
                {
                ...
                else if (hardware == "iPhone10,3" || hardware == "iPhone10,6"
                         || hardware == "iPhone11,2"//iPhone XS
                         || hardware == "iPhone11,4" //iPhone XS Max
                         || hardware == "iPhone11,6" //iPhone XS Max China
                         || hardware == "iPhone11,8"//iPhone XR
                        )
                {
                    return "iPhone X";
                }
                ...
                else if (hardware == "iPhone12,1"
                    || hardware == "iPhone12,3"  //iPhone 11 Pro - Model(s): A2160, A2215 & A2217 - Apple Tech specs: https://support.apple.com/kb/SP805
                    || hardware == "iPhone12,5" //iPhone 11 Pro Max - Model(s): A2161, A2218 & A2220 - Apple Tech specs: https://support.apple.com/kb/SP806
                    )
                {
                    return "iPhone 11";
                }
            ...
            if (hardware.StartsWith("iPad"))
            {
                ...
                // Model(s): A1395
                else if (hardware == "iPad2,1")
                {
                    return "iPad 2 WiFi";
                }
                // Model(s): A1396
                else if (hardware == "iPad2,2")
                {
                    return "iPad 2 GSM";
                }

                // Model(s): A1397
                else if (hardware == "iPad2,3")
                {
                    return "iPad 2 CDMA";
                }

                // Model(s): A1395
                else if (hardware == "iPad2,4")
                {
                    return "iPad 2 Wifi";
                }
                ...
                // Model(s): A1416
                else if (hardware == "iPad3,1")
                {
                    return "iPad 3 WiFi";
                }

                // Model(s): A1403
                else if (hardware == "iPad3,2")
                {
                    return "iPad 3 Wi-Fi + Cellular (VZ)";
                }

                // Model(s): A1430
                else if (hardware == "iPad3,3")
                {
                ...
                // Model(s): A1458
                else if (hardware == "iPad3,4")
                {
                    return "iPad 4 Wifi";
                }

                // Model(s): A1459
                else if (hardware == "iPad3,5")
                {
                    return "iPad 4 Wi-Fi + Cellular";
                }

                // Model(s): A1460
                else if (hardware == "iPad3,6")
                {
                ...
                // Model(s): A1474
                else if (hardware == "iPad4,1")
                {
                    return "iPad Air Wifi";
                }

                // Model(s): A1475
                else if (hardware == "iPad4,2")
                {
                    return "iPad Air Wi-Fi + Cellular";
                }

                // Model(s): A1476
                else if (hardware == "iPad4,3")
                {
                ...
                // Apple Tech specs: 
                // Model(s): A1566
                else if (hardware == "iPad5,3")
                {
                    return "iPad Air 2";
                }

                // Model(s): A1567
                else if (hardware == "iPad5,4")
                {
                    return "iPad Air 2";
                }
                ...
                // Model(s): A1584 (Wi-Fi) 
                else if (hardware == "iPad6,7")
                {
                    return "iPad Pro";
                }

                // Model(s): A1652 (Wi-Fi + Cellular)
                else if (hardware == "iPad6,8")
                {
                ...
                // Model(s): A1673
                else if (hardware == "iPad6,3")
                {
                    return "iPad Pro (9.7-inch)";
                }

                // Model(s): A1674, A1675 (Wi-Fi + Cellular)
                else if (hardware == "iPad6,4")
                {
                ...
                // Model(s): A1670
                else if (hardware == "iPad7,1")
                {
                    return "iPad Pro (12.9-inch) (2nd generation)";
                }

                // Model(s): A1671
                else if (hardware == "iPad7,2")
                {
                ...
                // Model(s): A1701
                else if (hardware == "iPad7,3")
                {
                    return "iPad Pro (10.5-inch)";
                }

                // Model(s): A1709
                else if (hardware == "iPad7,4")
                {
                ...
                // Model(s): A1432
                else if (hardware == "iPad2,5")
                {
                    return "iPad mini Wifi";
                }

                // Model(s): A1454
                else if (hardware == "iPad2,6")
                {
                    return "iPad mini Wi-Fi + Cellular";
                }

                // Model(s): A1455
                else if (hardware == "iPad2,7")
                {
                ...
                // Model(s): A1489
                else if (hardware == "iPad4,4")
                {
                    return "iPad mini 2 Wifi";
                }

                // Model(s): A1490
                else if (hardware == "iPad4,5")
                {
                    return "iPad mini 2 Wi-Fi + Cellular";
                }

                // Model(s): A1491
                else if (hardware == "iPad4,6")
                {
                ...
                // Apple Tech specs: 
                // Model(s): A1599
                else if (hardware == "iPad4,7")
                {
                    return "iPad mini 3 Wifi";
                }

                // Model(s): A1600
                else if (hardware == "iPad4,8")
                {
                    return "iPad mini 3 Wi-Fi + Cellular";
                }

                // Model(s): A1601
                else if (hardware == "iPad4,9")
                {
                ...
                // Model(s): A1538
                else if (hardware == "iPad5,1")
                {
                    return "iPad mini 4";
                }

                // Model(s): A1550
                else if (hardware == "iPad5,2")
                {
                ...
                // Model(s): A1822
                else if (hardware == "iPad6,11")
                {
                    return "iPad 5 Wi-Fi";
                }

                // Model(s): A1823
                else if (hardware == "iPad6,12")
                {
