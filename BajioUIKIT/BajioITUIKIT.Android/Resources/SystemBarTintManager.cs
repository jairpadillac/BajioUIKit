...
namespace BajioITUIKIT.Droid.Resources
{
    public class SystemBarTintManager
    {
        ...
        public void setStatusBarTintResource(Android.Graphics.Color res)
        {
            if (mStatusBarAvailable)
            {
        ...
        public class SystemBarConfig
        {
            ...
            {
                Android.Content.Res.Resources res = activity.Resources;
            ...
            private int getInternalDimensionSize(Android.Content.Res.Resources res, string key)
            {
                int result = 0;
